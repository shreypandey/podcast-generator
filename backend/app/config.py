...
_LOCALIZATION_MODE = (os.getenv("LOCALIZATION_MODE", "translate") or "translate").strip().lower()
LOCALIZATION_MODE = _LOCALIZATION_MODE if _LOCALIZATION_MODE in {"translate", "llm"} else "translate"
